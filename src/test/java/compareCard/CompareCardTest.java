...
public class CompareCardTest {
    ...
    public void should_return_level_is_one(){
        ...
        @Test
        public void should_return_winner_is_playerOne_By_level(){
            List<Card> playerOneCardList = new ArrayList<>();
            Card card1 = new Card("5H");
            Card card2 = new Card("6H");
            Card card3 = new Card("8C");
    ...
    @Test
    public void should_return_winner_is_playerOne_By_equalLevelOne(){
        List<Card> playerOneCardList = new ArrayList<>();
        Card card1 = new Card("5H");
        Card card2 = new Card("6H");
        Card card3 = new Card("8C");
        ...
        Card card7 = new Card("6H");
        Card card8 = new Card("8C");
        Card card9 = new Card("9D");
    ...
    @Test
    public void should_return_winner_is_playerOne_By_equalLevelTwo(){
        List<Card> playerOneCardList = new ArrayList<>();
    ...
    @Test
    public void should_return_winner_is_playerOne_By_equalLevelFour(){
        List<Card> playerOneCardList = new ArrayList<>();
        Card card1 = new Card("9H");
        Card card2 = new Card("9H");
        Card card3 = new Card("9C");
        Card card4 = new Card("8D");
        Card card5 = new Card("AS");
        playerOneCardList.add(card1);
        playerOneCardList.add(card2);
    ...
    @Test
    public void should_return_winner_is_playerOne_By_equalLevelFive(){
        List<Card> playerOneCardList = new ArrayList<>();
        Card card1 = new Card("3H");
        Card card2 = new Card("4H");
        Card card3 = new Card("5C");
        Card card4 = new Card("6D");
        ...
        Player playerOne = new Player("playerOne", playerOneCardList);
        List<Card> playerTwoCardList = new ArrayList<>();
        Card card6 = new Card("4H");
        Card card7 = new Card("5H");
        Card card8 = new Card("6C");
        Card card9 = new Card("7D");
        Card card10 = new Card("8S");
        playerTwoCardList.add(card6);
        playerTwoCardList.add(card7);
        playerTwoCardList.add(card8);
        playerTwoCardList.add(card9);
    ...
    @Test
    public void should_return_winner_is_playerOne_By_equalLevelSix(){
        List<Card> playerOneCardList = new ArrayList<>();
        Card card1 = new Card("3H");
        Card card2 = new Card("4H");
        Card card3 = new Card("9H");
        ...
        Player playerOne = new Player("playerOne", playerOneCardList);
        List<Card> playerTwoCardList = new ArrayList<>();
        Card card6 = new Card("4C");
        Card card7 = new Card("5C");
        Card card8 = new Card("6C");
        Card card9 = new Card("TC");
        Card card10 = new Card("8C");
        playerTwoCardList.add(card6);
        playerTwoCardList.add(card7);
        playerTwoCardList.add(card8);
        playerTwoCardList.add(card9);
    ...
    @Test
    public void should_return_winner_is_playerOne_By_equalLevelSeven(){
        List<Card> playerOneCardList = new ArrayList<>();
        ...
        List<Card> playerTwoCardList = new ArrayList<>();
        Card card6 = new Card("8C");
        Card card7 = new Card("8C");
        Card card8 = new Card("8H");
